...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lcdNumber = QtWidgets.QLCDNumber(self.groupBox_status)
        self.lcdNumber.setGeometry(QtCore.QRect(120, 50, 71, 31))
        self.lcdNumber.setObjectName("lcdNumber")
        self.lcdNumber_2 = QtWidgets.QLCDNumber(self.groupBox_status)
        self.lcdNumber_2.setGeometry(QtCore.QRect(120, 110, 71, 31))
    ...
    def clickeddoortest(self):
        MainWindow.close()
        self.doortestwin = QtWidgets.QMainWindow()
        self.doorui = doortest_ver2.Ui_doortest()
        self.doorui.setupUi(self.doortestwin)
        self.doortestwin.show() 
