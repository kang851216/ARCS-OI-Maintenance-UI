...
class Ui_loadcell_main(object):
    ...
    def loadcellread(self):
        ...
        self.textBrowser_3.display(int(loadcell1_val))
        self.textBrowser_4.display(int(loadcell2_val))
        self.textBrowser_5.display(int(loadcell_avg))
...
class Ui_loadcell_third(object):
    ...
    def loadcellread(self):
        ...
        self.hx_right.set_reading_format("MSB", "MSB")
        self.hx_left.set_reading_format("MSB", "MSB")
        self.hx_right.set_reference_unit(int(referenceunit))
        self.hx_left.set_reference_unit(int(referenceunit))
        self.hx_right.reset()
        self.hx_left.reset()
        self.hx_left.tare()
        self.hx_right.tare()
        ...
        self.text_loadcell1_value.display(int(loadcell1_val))
        self.text_loadcell2_value.display(int(loadcell2_val))
        loadcell_avg = (loadcell1_val + loadcell2_val) / 2
