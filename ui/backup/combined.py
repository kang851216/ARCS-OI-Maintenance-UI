...
class Ui_loadcell_second(object):
    ...
    def retranslateUi(self, loadcell_second):
        _translate = QtCore.QCoreApplication.translate
        loadcell_second.setWindowTitle(_translate("loadcell_second", "称重传感器校准"))
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setObjectName("label_2")
        self.textBrowser = QtWidgets.QTextBrowser(self.groupBox_status)
        self.textBrowser.setGeometry(QtCore.QRect(110, 50, 91, 41))
        self.textBrowser.setObjectName("textBrowser")
        self.textBrowser_2 = QtWidgets.QTextBrowser(self.groupBox_status)
