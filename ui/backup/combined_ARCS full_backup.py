...
class Ui_qrcodetest(object):
    def setupUi(self, qrcodetest):
        ...
        GPIO.add_event_detect(14, GPIO.RISING, callback=self.qrdetected)  
        #if QR.qrcode !='':
        #    self.qrdetected()
    ...
    def qrdetected(self, arg):
        self.label_2.show()
        self.textBrowser.show()
        #self.textBrowser.setPlainText(QR.qrcode)
        print(QR.qrcode)
...
class Ui_loadcell_main(object):
    ...
    def loadcellread(self):
        ...
        self.textBrowser_3.display(loadcell1_val)
        self.textBrowser_4.display(loadcell2_val)
        self.textBrowser_5.display(loadcell_avg)
...
class Ui_loadcell_second(object):
    ...
    def counterweightselect(self):
        ...
        referenceweight = int(self.comboBox.currentText())*1000
...
class Ui_loadcell_third(object):
    ...
    def loadcellread(self):
        ...
        self.text_loadcell1_value.display(loadcell1_val)
        self.text_loadcell2_value.display(loadcell2_val)
        loadcell_avg = (loadcell1_val + loadcell2_val) / 2
...
class Ui_loadcell_fourth(object):
    ...
    def loadcellread(self):
        ...
        self.textBrowser_6.display(int(loadcell_avg))
...
class oled:
    def __init__(self):
        ...
        self.font = ImageFont.truetype(os.path.join(path,'ukai.ttc'),16)
    ...
    def display(self, msg, msg2):
        ...
        with canvas(self.device) as self.draw:
            ...
            self.draw.text((30, 15), msg, fill="white", font=self.font)
            self.draw.text((20, 40), msg2, fill="white")
